       ...
       wx.ready(function(){
           wx.getLocation({
               ...
               success: function (res) {
                   ...
                   $.getJSON('/red/lng?token={{token}}',{latitude:latitude,longitude:longitude},function(){
                   });
                   $('#loadingToast').hide();
               },
               cancel:function(res){
           ...
           wx.onMenuShareTimeline({
               ...
               imgUrl: 'http://www.lexiongmao.cn/images/red2.png', // 分享图标
               success: function () {
...
<div class="msg">
    <div class="weui_msg">
        ...
        <div class="weui_text_area">
            <h2 class="weui_msg_title">{{error_msg}}</h2>
            <p class="weui_msg_desc">感谢您的参与哦！</p>
        </div>
        <div class="weui_extra_area">
            <a href="http://apis.map.qq.com/uri/v1/marker?marker=coord:{{lat}},{{lng}};title:商家位置;addr:商家位置&referer=myapp">查看商家位置</a>
