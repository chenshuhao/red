...
<div class="msg">
    <div class="weui_msg" style="padding-top: 5px;">
        <div class="weui_icon_area" >
            <img src="/{{tu}}" alt="长按扫描二维码" width="98%">
        </div>

        <div class="weui_extra_area">
            <a style="color:white" href="http://apis.map.qq.com/uri/v1/marker?marker=coord:{{lat}},{{lng}};title:商家位置;addr:商家位置&referer=myapp">查看商家位置</a>
